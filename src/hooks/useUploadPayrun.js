            ...
            parsedData.forEach(row => {
                ...
                Object.keys(row).forEach(key => {
                    ...
                    if (value != undefined || value != null) {
                        ...
                        const infosOnly = [
                            'Employee ID', 'Last Name', 'First Name', 'Middle Name', 'Email', 'Job Title', 'Date From', 'Date To', 'Date Payment',
                            'Total Taxes', 'Total Earnings', 'Total Deductions', 'Net Pay', 'Generated By', 'Source', 'Created At', 'sum-previous',
                            'Employee ID', 'Complete Name', 'TIN', 'Date Hired', 'Date Resigned', 'Coverage of Last Pay', 'payrun_start_date', 'payrun_end_date', 'Date Released',
                        ]

                        if (infosOnly.includes(key)) return;
                        ...
                        if (!payitem_id) {
                            alert(`payitem: ${key} cannot be mapped`);
                            return;
                        };
